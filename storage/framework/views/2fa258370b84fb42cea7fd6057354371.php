                ...
                <div class="filter-row">
                    ...
                    <div wire:ignore>
                        ...
                        <select id="salesSelect" class="form-select" multiple>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $allSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sale->id); ?>"><?php echo e($sale->name); ?></option>
                    ...
                    <div>
                        <button wire:click="toggleShowAll" class="btn btn-outline-primary w-100">
                            ...
                            <?php echo e($showAllSales ? 'แสดงทุกคน' : 'กรองบางคน'); ?>
            ...
            <div class="summary-grid">
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <h3><?php echo e(number_format($summaryData['total'] ?? 0)); ?></h3>
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <h3><?php echo e(number_format($summaryData['wait'] ?? 0)); ?></h3>
                        <p>รออนุมัติ</p>
                    </div>
                </div>
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <h3><?php echo e(number_format($summaryData['success'] ?? 0)); ?></h3>
                        <p>อนุมัติแล้ว (<?php echo e($summaryData['success_rate'] ?? 0); ?>%)</p>
                    </div>
                </div>
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <h3><?php echo e(number_format($summaryData['cancel'] ?? 0)); ?></h3>
                        <p>ไม่อนุมัติ (<?php echo e($summaryData['cancel_rate'] ?? 0); ?>%)</p>
                    </div>
                </div>
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <h3>฿<?php echo e(number_format($summaryData['total_amount'] ?? 0, 2)); ?></h3>
            ...
            <div class="data-card">
                <div class="table-responsive">
                    <table class="data-table">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $salesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="sale-avatar">
                                                <?php echo e(substr($data['sale']['name'] ?? 'N', 0, 1)); ?>

                                            </div>
                                            <div>
                                                <div style="font-weight: 600;"><?php echo e($data['sale']['name'] ?? 'N/A'); ?></div>
                                                <small class="text-muted"><?php echo e($data['sale']['email'] ?? ''); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge badge-info"><?php echo e($data['total']); ?></span>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge badge-warning"><?php echo e($data['wait']); ?></span>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge badge-success"><?php echo e($data['success']); ?></span>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge badge-danger"><?php echo e($data['cancel']); ?></span>
                                    </td>
                                    <td>
                                        <div>
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                <span style="font-size: 13px; color: #10b981; font-weight: 600;">
                                                    สำเร็จ: <?php echo e($data['success_rate']); ?>%
                                                </span>
                                                <span style="font-size: 13px; color: #ef4444; font-weight: 600;">
                                                    ยกเลิก: <?php echo e($data['cancel_rate']); ?>%
                                                </span>
                                            </div>
                                            <div class="progress-bar">
                                                <div class="progress-fill success" style="width: <?php echo e($data['success_rate']); ?>%"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end" style="font-weight: 600; color: #10b981;">
                                        ฿<?php echo e(number_format($data['total_amount'], 2)); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#salesSelect').on('change', function() {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('selectedSales', selectedValues);
            });
...
<?php /**PATH C:\laragon\www\charoenmun\resources\views/livewire/reports/sales-report.blade.php ENDPATH**/ ?>