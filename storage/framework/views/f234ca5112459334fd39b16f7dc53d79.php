...
<div>
    ...
    <div class="row mb-3">
        <div class="col-md-12 mb-2">
            <h3>
                รายการใบเสนอราคา
             <a href="<?php echo e(route('quotations.create')); ?>" class="float-end btn btn-primary"> + เพิ่มใบเสนอราคา</a>
            </h3>
        </div>
        <div class="col-md-9">
            <input
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $quotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><?php echo quote_status_badge($q->quote_status); ?></td>
                            <td><?php echo e($q->quote_date->format('d/m/Y')); ?></td>
                            <td><?php echo e($q->customer->customer_name); ?></td>
                            <td class="text-end"><?php echo e(number_format($q->quote_grand_total, 2)); ?></td>
                            <td><?php echo e($q->sale->name); ?></td>
                            <td class="text-center">
                                <a href="<?php echo e(route('quotations.print', $q->id)); ?>" class="text-purple me-2">
                                    <i class="ri-printer-line" style="font-size: 20px;"></i> ปริ้น
                                </a>
                                <a href="<?php echo e(route('quotations.edit', $q)); ?>" class="text-info me-2">
                                    <i class="mdi mdi-file-sign" style="font-size: 20px;"> </i>แก้ไข
                                </a>
                                <a wire:click="delete(<?php echo e($q->id); ?>)" class="text-danger" onclick="return confirm('ยืนยันลบ?')">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const initialStatusData   = <?php echo json_encode($statusData ?? [], 15, 512) ?>;
            const initialCustomerData = <?php echo json_encode($customerData ?? [], 15, 512) ?>;
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/charoenmun-new/resources/views/livewire/quotations/quotation-index.blade.php ENDPATH**/ ?>