                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-2">
                        <div class="p-3 h-100 d-flex flex-wrap align-items-center gap-2"
                            ...
                            <div class="mb-2 d-flex flex-wrap align-items-center gap-2">
                                <span><b>VAT:</b> <span class="text-primary">{{ number_format($order->order_vat, 2) }}</span> บาท
                                </span>
                                <span><b>ส่วนลด:</b> <span class="text-danger">{{ number_format($order->order_discount, 2) }}</span>
                                    บาท</span>
                                <span style="font-weight:700; color:#059669;"><b>สุทธิ:</b> <span
                                        class="text-success">{{ number_format($order->order_grand_total, 2) }}</span> บาท</span>
                            </div>
